        ...
        <div class="row">
            <div class="col-lg-8 col-md-8">
                <div class="rachive-info-cats">
                    <a href=" "><i class="las la-home"></i> </a> <i
                        class="las la-chevron-right"></i>{{ $Subbreadcat->subcategory_name }}
                </div>
                <div class="row">
                                ...
                                <div class="archive-shadow arch_margin">
                                    <div class="archive1_image">
                                        ...
                                        <div class="archive1-meta">
                                            <a href="{{ url('news/details/' . $item->id . '/' . $item->news_title_slug) }}"><i
                                                    class="la la-tags"> </i>
                                                ...
                                                <div class="archive-shadow arch_margin">
                                                    ...
                                                    <div class="archive1-padding">
                                                        <div class="archive1-title2"><a
                                                                href=""{{ url('news/details/' . $item->id . '/' . $item->news_title_slug) }}>{!! Str::limit($item->news_title, 100) !!}</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="archive1-custom-col-12">
                                    <div class="archive-item-wrpp2">
                                        <div class="archive-shadow arch_margin">
                                            ...
                                            <div class="archive1-padding">
                                                <div class="archive1-title2"><a href=" "></a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="siteber-add">
                        <div class="themesBazar_widget">
                            <div class="textwidget">
                                <p> <img style="width: 300px;height:300px"

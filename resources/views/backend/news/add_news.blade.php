                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 mb-3">
                                        <label for="inputEmail4" class="form-label">Category Name</label>
                                                                               ...
                                                                               <select  name="category_id" id="heard" class="form-select parsley-success" required="" data-parsley-id="21">
                                            <option value="">Choose..</option>
                                            @foreach ($categories as $item)
                                            <option value="{{ $item->id }}" >{{ $item->category_name }}</option>
                                        @endforeach
                                        </select><ul class="parsley-errors-list" id="parsley-id-21" aria-hidden="true"></ul>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 mb-3">
                                        <div class="form-check mb-2 form-check-success">
                                            <input class="form-check-input rounded-circle" type="checkbox" name="first_section_three" value="1" id="customckeck3">
                                                    <label class="form-check-label" for="customckeck3">First Section Three</label>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-6 mb-3">
                                        <div class="form-check mb-2 form-check-success">
                                            <input class="form-check-input rounded-circle" type="checkbox" name="first_section_nine" value="1" id="customckeck4">

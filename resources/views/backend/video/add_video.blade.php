                        ...
                        <form id="myForm" method="post" action="{{ route('video.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="title" name="video_title" placeholder="Video Title" >
                                </div>
                                <div class="form-group col-md-6 mb-3">
                                    <label for="" class="form-label">Video Url</label>
                                    <input type="text" class="form-control" id="title" name="video_url" placeholder="Video Title" >
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
